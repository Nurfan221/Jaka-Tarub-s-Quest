...
public class QuestInfoUI : MonoBehaviour
{
    ...
    public List<QuestSO> quest = new List<QuestSO>(); // List untuk menampung data Quest dari QuestManager
    ...
    public void DisplayActiveQuest(QuestSO questActive)
    {
